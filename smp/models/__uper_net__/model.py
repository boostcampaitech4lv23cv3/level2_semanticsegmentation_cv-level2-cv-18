...
class Resnet_UperNet_Base(BaseModel):
    # Implementing only the object path
    def __init__(self, num_classes=11, in_channels=3, backbone='resnet101', pretrained=True, use_aux=True, fpn_out=256, freeze_bn=False, freeze_backbone=False, **_):
        super(Resnet_UperNet_Base, self).__init__()
